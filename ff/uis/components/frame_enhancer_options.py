...
from ff.processors.modules.frame_enhancer import choices as frame_enhancer_choices
from ff.processors.modules.frame_enhancer.types import FrameEnhancerModel
...
def render() -> None:
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'ff.processors.modules.frame_enhancer'),
	...
	FRAME_ENHANCER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'ff.processors.modules.frame_enhancer'),
