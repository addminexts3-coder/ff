...
import ff.choices
from ff import state_manager, translator, voice_extractor
from ff.filesystem import is_video
from ff.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = ff.choices.voice_extractor_models,
