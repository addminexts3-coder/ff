...
from ff.processors.modules.lip_syncer import choices as lip_syncer_choices
from ff.processors.modules.lip_syncer.types import LipSyncerModel, LipSyncerWeight
...
def render() -> None:
	...
	LIP_SYNCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'ff.processors.modules.lip_syncer'),
	...
	LIP_SYNCER_WEIGHT_SLIDER = gradio.Slider(
		label = translator.get('uis.weight_slider', 'ff.processors.modules.lip_syncer'),
