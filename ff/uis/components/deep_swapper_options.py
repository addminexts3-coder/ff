...
from ff.processors.modules.deep_swapper import choices as deep_swapper_choices
from ff.processors.modules.deep_swapper.types import DeepSwapperModel
...
def render() -> None:
	...
	DEEP_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'ff.processors.modules.deep_swapper'),
	...
	DEEP_SWAPPER_MORPH_SLIDER = gradio.Slider(
		label = translator.get('uis.morph_slider', 'ff.processors.modules.deep_swapper'),
