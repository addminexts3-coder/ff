...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(ff.choices.execution_thread_count_range),
		minimum = ff.choices.execution_thread_count_range[0],
		maximum = ff.choices.execution_thread_count_range[-1]
	)
