...
from ff.processors.modules.face_enhancer import choices as face_enhancer_choices
from ff.processors.modules.face_enhancer.types import FaceEnhancerModel, FaceEnhancerWeight
...
def render() -> None:
	...
	FACE_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'ff.processors.modules.face_enhancer'),
	...
	FACE_ENHANCER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'ff.processors.modules.face_enhancer'),
	...
	FACE_ENHANCER_WEIGHT_SLIDER = gradio.Slider(
		label = translator.get('uis.weight_slider', 'ff.processors.modules.face_enhancer'),
