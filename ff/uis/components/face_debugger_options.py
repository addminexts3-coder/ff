...
from ff.processors.modules.face_debugger import choices as face_debugger_choices
from ff.processors.modules.face_debugger.types import FaceDebuggerItem
...
def render() -> None:
	...
	FACE_DEBUGGER_ITEMS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		label = translator.get('uis.items_checkbox_group', 'ff.processors.modules.face_debugger'),
