...
from ff.common_helper import calculate_int_step
from ff.processors.core import load_processor_module
from ff.processors.modules.background_remover import choices as background_remover_choices
from ff.processors.modules.background_remover.types import BackgroundRemoverModel
...
def render() -> None:
	...
	BACKGROUND_REMOVER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'ff.processors.modules.background_remover'),
	...
	with gradio.Group(visible = has_background_remover) as BACKGROUND_REMOVER_FILL_COLOR_WRAPPER:
		with gradio.Row():
			BACKGROUND_REMOVER_FILL_COLOR_RED_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_red_number', 'ff.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_FILL_COLOR_GREEN_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_green_number', 'ff.processors.modules.background_remover'),
		...
		with gradio.Row():
			BACKGROUND_REMOVER_FILL_COLOR_BLUE_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_blue_number', 'ff.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_FILL_COLOR_ALPHA_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_alpha_number', 'ff.processors.modules.background_remover'),
	...
	with gradio.Group(visible = has_background_remover) as BACKGROUND_REMOVER_DESPILL_COLOR_WRAPPER:
		with gradio.Row():
			BACKGROUND_REMOVER_DESPILL_COLOR_RED_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_red_number', 'ff.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_DESPILL_COLOR_GREEN_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_green_number', 'ff.processors.modules.background_remover'),
		...
		with gradio.Row():
			BACKGROUND_REMOVER_DESPILL_COLOR_BLUE_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_blue_number', 'ff.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_DESPILL_COLOR_ALPHA_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_alpha_number', 'ff.processors.modules.background_remover'),
