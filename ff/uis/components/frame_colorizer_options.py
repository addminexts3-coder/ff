...
from ff.processors.modules.frame_colorizer import choices as frame_colorizer_choices
from ff.processors.modules.frame_colorizer.types import FrameColorizerModel
...
def render() -> None:
	...
	FRAME_COLORIZER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'ff.processors.modules.frame_colorizer'),
	...
	FRAME_COLORIZER_SIZE_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.size_dropdown', 'ff.processors.modules.frame_colorizer'),
	...
	FRAME_COLORIZER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'ff.processors.modules.frame_colorizer'),
