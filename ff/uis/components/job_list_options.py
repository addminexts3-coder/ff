...
from ff.types import JobStatus
...
def update_job_status_checkbox_group(job_statuses : List[JobStatus]) -> gradio.CheckboxGroup:
	job_statuses = job_statuses or ff.choices.job_statuses
